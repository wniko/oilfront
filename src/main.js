...
//后端项目的URL根路径
let baseUrl = "https://frontoil.yundeos.com/oil/"
// let baseUrl = "http://localhost:8090/oil/"
...
app.config.globalProperties.$httpGet = function(url, method, data, async, fun) {
    $.ajax({
        url: baseUrl + url,
        type: method,
        // dataType: 'json',
