<template>
    <div>
        ...
        <!-- 复选框 -->
            ...
            <!-- 通过prop输出到表格中 -->
            <el-table-column prop="nickname" header-align="center" align="center" min-width="100" label="昵称" />
            <el-table-column prop="businessName" header-align="center" align="center" min-width="150" label="公司名称" />
            <el-table-column prop="businessLinkman" header-align="center" align="center" min-width="150" label="公司联系人" />
             <el-table-column prop="phone" header-align="center" align="center" min-width="150" label="联系号码" />
            <el-table-column prop="businessAddress" header-align="center" align="center" min-width="150" label="公司地址" />
            ...
            <el-table-column prop="businessPicture" header-align="center" align="center" min-width="150" label="营业执照" >
                <template #default="scope">
                    <el-image 
                            v-if="scope.row.businessPicture != null"
							style="width: 100px; height: 100px"
							:src="scope.row.businessPicture"
					></el-image>
                </template>
            </el-table-column>
...
<script>
//引入弹窗页面
import AddOrUpdate from './businessInfo-add-or-update.vue';
...
export default {
    ...
    methods: {
        loadDataList: function() {
            ...
            //提交ajax请求
            that.$http('businessInfo/listByPage', 'POST', data, true, function(resp) {
                resp.data.list.map(list =>{
                    if(list.businessPicture != null){
                        list.businessPicture = that.$baseUrl+"img/"+list.businessPicture
                    }
                } )
